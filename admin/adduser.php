            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                if($username == "" || $password == "" || $role == "" || $email == ""){
                    echo "<span class='error'>field must not be empty!!! </span>";
                        ...
                        $esql = "SELECT * from db_user where email ='$email'";
                        $value =$db->conn->prepare($esql);
                        $value->execute();
                        $data = $value->fetchAll();
                        ...
                        if($value->rowCount() > 0){
                            ...
                            $sql="INSERT INTO  db_user (username,password,email,role) VALUES('$username','$password',' $email','$role')";
